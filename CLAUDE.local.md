...
**YOU ARE IN: `russh/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/russh/` (rig root) or other directories
...
**Your mail address:** `russh/polecats/rust`
**Your rig:** russh
**Your Witness:** `russh/witness`
...
| Ask Witness for help | `gt mail send russh/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`russh/witness`) when:
...
```bash
gt mail send russh/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
